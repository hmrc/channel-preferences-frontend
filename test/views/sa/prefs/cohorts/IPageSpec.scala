...
class IPageSpec extends UnitSpec with OneAppPerSuite with WelshLanguage {
  ...
  "I Page Template" should {
    "render the correct content in english" in {
      ...
      val document = Jsoup.parse(i_page(form, internal.routes.ChoosePaperlessController.submitForm(TestFixtures.sampleHostContext))(AuthenticatedRequest(FakeRequest("GET", "/"), None, None, None, None), applicationMessages).toString())
