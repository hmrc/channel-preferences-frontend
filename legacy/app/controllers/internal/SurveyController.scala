...
class SurveyController @Inject() (
  ...
  def returnToFormWithErrors(submitSurveyFormAction: Call)(
    form: Form[SurveyReOptInDeclinedDetailsForm.Data]
  ...
  def auditSurvey(languagePreference: Some[Language], userData: SurveyReOptInDeclinedDetailsForm.Data)(implicit
