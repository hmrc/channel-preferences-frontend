...
class TransformSpec extends BaseSpec {
  ...
  "Serialization" should {
    ...
    "transform a benefit to json" in {
      val benefit = Benefit(31, 2013, 3333, 1, null, null, null, null, null, null, Some(Car(None, None, Some(new LocalDate(2013, 3, 12)), Some(0), Some("diesel"), Some(2), Some(1400), Some(9999))), Map.empty, Map.empty)
