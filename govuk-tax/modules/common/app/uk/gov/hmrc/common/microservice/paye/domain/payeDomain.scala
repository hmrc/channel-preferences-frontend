...
case class PayeRoot(nino: String, version: Int, title: String, name: String, dateOfBirth: String, links: Map[String, String], transactionLinks: Map[String, String]) extends RegimeRoot {
