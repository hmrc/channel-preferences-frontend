...
object MicroServiceConfig {
  ...
  lazy val idaTokenRequired = Play.configuration.getBoolean(s"govuk-tax.$env.services.saml.idaTokenRequired").getOrElse(false)
  lazy val idaTokenApiUser = Play.configuration.getString(s"govuk-tax.$env.services.saml.idaTokenRequired")
  lazy val idaTokenApiPass = Play.configuration.getString(s"govuk-tax.$env.services.saml.idaTokenRequired")
