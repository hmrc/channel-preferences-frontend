...
case class Benefit(benefitType: Int, taxYear: Int, grossAmount: BigDecimal, employmentSequenceNumber: Int, cars: Seq[Car], actions: Map[String, String], calculations: Map[String, String]) {
