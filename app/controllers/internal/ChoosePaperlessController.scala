...
class ChoosePaperlessController @Inject()(
  ...
  def redirectToDisplayFormWithCohort(
    ...
    hostContext: HostContext): Action[AnyContent] = authorise { implicit request =>
  ...
  def displayFormBySvc(
    ...
    token: String,
    emailAddress: Option[Encrypted[EmailAddress]],
    hostContext: HostContext) = authorise.async { implicit request =>
    {
      implicit val hc: HeaderCarrier =
        HeaderCarrierConverter.fromHeadersAndSession(request.headers)
  ...
  private def createRedirectToDisplayFormWithCohort(
    emailAddress: Option[Encrypted[EmailAddress]],
    hostContext: HostContext)(implicit request: AuthenticatedRequest[_]) =
    Redirect(
  ...
  def displayForm(
    ...
    emailAddress: Option[Encrypted[EmailAddress]],
    hostContext: HostContext): Action[AnyContent] = authorise.async { implicit request =>
    implicit val hc: HeaderCarrier =
      HeaderCarrierConverter.fromHeadersAndSession(request.headers)
  ...
  def submitFormBySvc(implicit svc: String, token: String, hostContext: HostContext) = authorise.async {
    implicit request =>
      implicit val hc: HeaderCarrier =
        HeaderCarrierConverter.fromHeadersAndSession(request.headers)
  ...
  def displayNearlyDone(emailAddress: Option[Encrypted[EmailAddress]], hostContext: HostContext) = authorise {
    implicit request =>
