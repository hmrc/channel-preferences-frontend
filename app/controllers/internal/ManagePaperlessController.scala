...
class ManagePaperlessController @Inject()(
  ...
  private[controllers] def _displayStopPaperlessConfirmed(
    implicit
  ...
  private[controllers] def _resendVerificationEmail(
    implicit
    request: AuthenticatedRequest[_],
    hostContext: HostContext,
  ...
  private[controllers] def _displayStopPaperless(
    implicit
    request: AuthenticatedRequest[_],
    hostContext: HostContext,
    hc: HeaderCarrier): Future[Result] =
  ...
  private[controllers] def _displayChangeEmailAddress(
    ...
    lookupCurrentEmail(
      email =>
        Future.successful(
          Ok(
            accountDetailsUpdateEmailAddress(
              email,
  ...
  private[controllers] def _submitChangeEmailAddress(
    implicit
    request: AuthenticatedRequest[_],
    hostContext: HostContext,
    hc: HeaderCarrier): Future[Result] =
  ...
  private[controllers] def _displayChangeEmailAddressConfirmed(
    implicit
    request: AuthenticatedRequest[_],
    hostContext: HostContext,
    hc: HeaderCarrier): Future[Result] =
  ...
  def displayChangeEmailAddress(
    implicit
    emailAddress: Option[Encrypted[EmailAddress]],
    hostContext: HostContext): Action[AnyContent] =
