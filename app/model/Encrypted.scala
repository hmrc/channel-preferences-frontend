...
object Encrypted {
  implicit def encryptedStringToDecryptedEmail(
    implicit
    stringBinder: QueryStringBindable[String]): QueryStringBindable[Encrypted[EmailAddress]] =
  ...
  implicit def encryptedStringToDecryptedString(
    implicit
    stringBinder: QueryStringBindable[String]): QueryStringBindable[Encrypted[String]] =
